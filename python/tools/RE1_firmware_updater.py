...
group.add_argument("--install-version", "--install_version", help="Install a specific firmware version", action="store_true")
group.add_argument("--install-branch", "--install_branch", help="Install the HEAD of a specific branch", action="store_true")
group.add_argument("--install-path", "--install_path", help="Install the firmware on the provided path (eg ./stretch_firmware/arduino)", type=str)
...
parser.add_argument("--left-wheel", "--left_wheel", help="Upload Left Wheel Stepper firmware", action="store_true")
parser.add_argument("--right-wheel", "--right_wheel", help="Upload Right Wheel Stepper firmware", action="store_true")
parser.add_argument("--pimu-device", help=argparse.SUPPRESS, type=str)
parser.add_argument("--wacc-device", help=argparse.SUPPRESS, type=str)
parser.add_argument("--arm-device", help=argparse.SUPPRESS, type=str)
parser.add_argument("--lift-device", help=argparse.SUPPRESS, type=str)
parser.add_argument("--left-wheel-device", "--left_wheel-device", help=argparse.SUPPRESS, type=str)
parser.add_argument("--right-wheel-device", "--right_wheel-device", help=argparse.SUPPRESS, type=str)
