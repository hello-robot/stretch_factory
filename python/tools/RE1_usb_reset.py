...
import stretch_factory.device_mgmt #import StretchDeviceMgmt
stretch_factory.device_mgmt.reset_all_hello_dynamixel_devices(verbose=True)
stretch_factory.device_mgmt.reset_all_hello_arduino_devices(verbose=True)
